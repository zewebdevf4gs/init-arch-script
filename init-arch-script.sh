...
sudo pacman-contrib piper gftp xfce4-whiskermenu-plugin virt-viewer python-pip xcape ntfs-3g firefox vlc gparted gnome-disk-utility baobab galculator p7zip psensor virt-manager qemu-desktop libvirt edk2-ovmf dnsmasq iptables-nft syncthing
